export const SoulNumberData = {
  ...
  4: {
    ...
    title: "Số linh hồn 4",
    describe:
      "Số 4 là con số của thực tế, thế nên khi có Con số linh hồn 4, những người này thường có những quan điểm khá truyền thống và bảo thủ trong các chủ đề thuộc vẻ tinh thần, tâm linh và cảm xúc, chẳng hạn như tôn giáo, tình yêu, hôn nhân và cuộc sống nói chung. Họ thường rất tôn trọng các nguyên tắc truyền thống và không để cho cảm xúc của mình bộc phát. ",
  },
  5: {
    id: 5,
    title: "Số linh hồn 5",
    describe:
      "Sức mạnh của con số này đến từ vị trí của số 5 trên Trục ngang Tinh thần, cho thấy người sở hữu nó có những cảm xúc rất sâu sắc, cũng như có nhu cầu được tự do và được chấp nhận - tốt nhất là những cảm xúc này được bộc lộ. Họ sẽ có cảm xúc mãnh liệt trong bất kỳ phương diện cuộc sống nào mà họ đang đối mặt và không ngại biểu đạt điều đó, trừ khi Biểu đồ ngày sinh của họ có yếu tố cản trở.",
  },
  6: {
    id: 6,
    title: "Số linh hồn 6",
    describe:
      "Nhóm này được thôi thúc hướng vẻ tình yêu thương và sự sáng tạo. Họ sẽ tận dụng mọi cơ hội để thể hiện bản thân mình một cách đây sáng tạo, cho dù đó là trong công việc, gia đình hay một sở thích nào đó. Tuy nhiên, do đặc tính nhạy cảm của số 6, họ phải giữ vững tinh thần, nếu họ lo lắng quá mức thì sức mạnh này sẽ nhanh chóng chuyển thành cảm giác tuyệt vọng và chán nản.",
  },
  7: {
    id: 7,
    title: "Số linh hồn 7",
  ...
  8: {
    ...
    title: "Số linh hồn 8",
    describe:
      "Con số này tập trung vào tính thích độc lập. Người sở hữu Con số linh hồn 8 thường tự động từ chối làm theo những thói quen mà họ thấy là vô lý. Họ có suy nghĩ và cách hành xử riêng, nhưng cần cẩn thận để tránh trở thành người xa cách cộng đồng. Một bài học quan trọng cuộc sống dạy chúng ta là nhu câu hòa nhập cùng cộng đồng mà không bị lệ thuộc vào đó. ",
  },
  9: {
    id: 9,
    title: "Số linh hồn 9",
